...
titleHead.innerText = "Hello, Buddy!";
...
inputSearchForm.placeholder = "Search for your recipe";
...
// Api url and key
const apiId = "&app_id=31af3d6c";
const apiKey = "&app_key=2b281f1b42fe81501b5658481f98a2be";
...
searchForm.addEventListener("submit", (e) => {
  ...
  titleHead.innerHTML = `Welcome, Buddy`;
  subTitleHead.innerHTML = "Hope, you find what you are looking for";
